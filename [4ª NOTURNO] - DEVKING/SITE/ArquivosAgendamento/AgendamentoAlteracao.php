...
<!-- Div Principal [Início]  -->
      <div id="content" class="p-4 p-md-5 pt-5" >
        <h2 class="mb-4 text-center text-muted">Alteração de paciente</h2>
        <div class="container">
...
<!--Conteúdo página [Início] -->
		...
		setlocale(LC_ALL,'pt_BR.UTF8');
			...
			<div class="form-row">
					...
					<label for="NomeDentista">Código do Agendamento:</label>
					<input 	
					type="text"
					name="id"
					maxlength="15"
					...
					<select select name="nomeDentista" class="form-control" required>
					...
					<select name="tratamento" class="form-control" required>
					...
					<button type="submit" class="btn btn-primary">Cadastrar Alteração</button>
