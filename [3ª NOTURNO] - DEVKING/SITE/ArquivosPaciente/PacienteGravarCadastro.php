...
//<!-- Verificação de dados [Início]  -->
	...
	if ($cpf=="")
	{
		...
		die("<h3 class='mb-4 text-center'>Cadastramento cancelado</h3> <a href='paginaCadastroPaciente.php'><button type='button' name='btnRecomecar' class='btn btn-primary'>Voltar</button></a>");
	}
	...
	//6 - Verificaçao de email digitado com o campo de confirmação E-mail.
	if($email != $email1)
	{
		echo"<h3 class='mb-4 text-center'>Email diferente do campo | E-mail (Confirmação)</h3>";
		die("<h3 class='mb-4 text-center'>Cadastramento cancelado</h3> <a href='paginaCadastroPaciente.php'><button type='button' name='btnRecomecar' class='btn btn-primary'>Voltar</button></a>");
	}
	//6.1 - E-mail não pode ser maior que 100 caracteres ou vazio.
...
//<!-- Verificação de dados [Fim]  -->
	...
	echo "Nome Responsável: $nomeResponsavel <br>" ;
	echo "Telefone Responsável: $telefoneResponsavel <br>" ;
	...
	NOME_RESPONSAVEL_PACIENTE,
	TELEFONE_RESPONSAVEL_PACIENTE,
	SEXO_PACIENTE
	
	) VALUES

	 
	('$cpf', '$nome', '$rg', '$dataNasc', '$dataCad', '$email', '$telefone', 
	'$cep', '$endereco', '$numeroCasa', '$bairro', '$cidade', 
	 '$uf', '$obs', '$nomeResponsavel', '$telefoneResponsavel', '$genero')";
...
echo "<h3 class='mb-4 text-center'>Cadastramento cancelado</h3> <a href='paginaCadastroPaciente.php'><button type='button' name='btnRecomecar' class='btn btn-primary'>Voltar para cadastro de pacientes</button></a>";
echo "<br><br>";
