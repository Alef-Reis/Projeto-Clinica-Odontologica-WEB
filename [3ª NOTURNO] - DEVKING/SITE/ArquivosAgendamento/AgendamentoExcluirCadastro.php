...
<?php
	...
	$comandoSQL="DELETE FROM AGENDAMENTO WHERE CODIGO_AGENDAMENTO=$codigo";
	
	// Exibindo o comando na tela para copiar e testar no console
	//die($sql);
	echo "<h3>Ops algo deu errado, tente novamente por favor</h3>";
	echo "<a href='paginaListaAgendamentos.php'><button>Voltar para listagem de pacientes</button></a>";
	echo "<br><br>";
...
//Redirecionar
header('Location: paginaListaAgendamentos.php');
