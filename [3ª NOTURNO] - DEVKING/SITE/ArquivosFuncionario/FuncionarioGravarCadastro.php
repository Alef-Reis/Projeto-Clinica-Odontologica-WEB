...
//<!-- Verificação de dados [Início]  -->
	...
	if (strlen($usuario) > 12 )
	{
		...
		die("<h3 class='mb-4 text-center'>Cadastramento cancelado</h3> <a href='paginaCadastroFuncionario.html'><button type='button' name='btnRecomecar' class='btn btn-primary'>Voltar</button></a>");
	}
	...
	if ($cpf=="")
	{
		...
		die("<h3 class='mb-4 text-center'>Cadastramento cancelado</h3> <a href='paginaCadastroFuncionario.php'><button type='button' name='btnRecomecar' class='btn btn-primary'>Voltar</button></a>");
	}
	...
	//9 - Verificaçao de email digitado com o campo de confirmação E-mail.
	if($email != $email1)
	{
...
echo "<a href='../index.php'><button>Voltar para listagem de pacientes</button></a>";
echo "<br><br>";
